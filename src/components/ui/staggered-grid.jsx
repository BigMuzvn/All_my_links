...
// Icônes de marque de Godson (au lieu du set générique Github/Slack/Twitter
// du composant d'origine), pour que la grille reflète les vrais réseaux.
const GRID_ICONS = [
    { file: 'instagram.svg', label: 'Instagram' },
    { file: 'tiktok.svg', label: 'TikTok' },
    { file: 'youtube.svg', label: 'YouTube' },
    { file: 'snapchat.svg', label: 'Snapchat' },
    { file: 'whatsapp.svg', label: 'WhatsApp' },
    { file: 'facebook.svg', label: 'Facebook' },
    { file: 'x.svg', label: 'X' },
]
                ...
                <div ref={gridFullRef} className="grid--full relative w-full my-[10vh] h-auto aspect-[1.1] max-w-none p-4 grid gap-4 grid-cols-7 grid-rows-5">
                    ...
                    {mixedGridItems.map((item, i) => {
                        ...
                        if (typeof item === 'string') {
                            const { file, label } = GRID_ICONS[i % GRID_ICONS.length];
                                    ...
                                    <div className="grid__item-img w-full h-full [backface-visibility:hidden] will-change-transform rounded-xl overflow-hidden shadow-sm border border-zinc-200 dark:border-zinc-900 bg-zinc-100 dark:bg-zinc-950 flex items-center justify-center transition-all duration-500 ease-out group-hover:scale-105 group-hover:shadow-xl group-hover:border-transparent">
                                        ...
                                        <div className="relative z-10 flex flex-col items-center justify-center gap-3">
                                            ...
                                            <img
                                                ...
                                                alt=""
                                                className="w-8 h-8 opacity-60 transition-all duration-300 group-hover:opacity-100 group-hover:scale-110 dark:invert"
                                            />
