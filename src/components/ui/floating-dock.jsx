"use client";
/**
 * Version simplifiée : la rangée d'icônes reste identique sur mobile et
 * desktop (pas de menu repliable) — plus simple et plus fiable qu'un menu
 * qui se déplie, qui posait des problèmes de positionnement près du bord.
 **/
